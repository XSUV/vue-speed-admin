...
import { hasClass, storageLocal, toggleClass } from '@/utils/tools';
import { isBoolean } from 'element-plus/es/utils/types';
...
export function useTags() {
  ...
  const tagsViews = reactive<tagsViewsType[]>([
    {
      icon: RefreshRight,
      text: '重新加载',
      divided: false,
  ...
  function onContentFullScreen() {
    speedSetting.hiddenSideBar
      ? speedSetting.changeSetting({ key: 'hiddenSideBar', value: false })
      : speedSetting.changeSetting({ key: 'hiddenSideBar', value: true });
  }
