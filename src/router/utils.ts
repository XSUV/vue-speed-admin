...
import { isString } from 'element-plus/es/utils/types';
import { cloneDeep } from 'lodash-es';
import { isAllEmpty, intersection, storageLocal, isIncludeAllChildren } from '@/utils/tools';
...
/** 判断两个数组彼此是否存在相同值 */
function isOneOfArray(a: string[], b: string[]) {
...
/** 是否有按钮级别的权限 */
function hasAuth(value: string | string[]): boolean {
